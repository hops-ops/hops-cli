...
pub const LOCAL_VALUES: &str = include_str!("templates/local-values.yaml.tmpl");
pub const DEPLOY_VALUES: &str = include_str!("templates/deploy-values.yaml.tmpl");
pub const DEPLOYMENT: &str = include_str!("templates/deployment.yaml.tmpl");
pub const SERVICE: &str = include_str!("templates/service.yaml.tmpl");
